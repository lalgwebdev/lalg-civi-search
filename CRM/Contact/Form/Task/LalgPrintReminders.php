...
/**
 * This class is for printing Postal Reminders
 ...
 */
class CRM_Contact_Form_Task_LalgPrintReminders extends CRM_Contact_Form_Task_PDF {

  public function buildQuickForm() {
    parent::buildQuickForm();
    CRM_Utils_System::setTitle('Print LALG Reminders');
  }

  // Would like to customise form template
