 ...
 */
class CRM_LalgCiviSearch_Upgrader_Base {

  /**
   * @var CRM_LalgCiviSearch_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_LalgCiviSearch_Upgrader(
        'lalg-civi-search',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_LalgCiviSearch_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_LalgCiviSearch_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
