(function(angular, $, _) {
  ...
  angular.module('testTask', CRM.angRequires('testTask'));
  
  angular.module('testTasks').controller('crmSearchTaskDownload', function($scope, $http, searchTaskBaseTrait, $timeout, $interval) {
